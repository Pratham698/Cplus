...
public class EmployeeMapper implements ResultSetMapper<Employee> {
  ...
  public final Employee map(final int idx, final ResultSet rs, final StatementContext ctx) throws SQLException {
     ...
     * @return Employee
     */
    return new Employee(rs.getInt("empId"),rs.getInt("mgr_id"),rs.getString("fname"), rs.getString("lname"), rs.getString("dept"), rs.getString("mail"), rs.getInt("contactno"),rs.getInt("avail_leaves") ,rs.getDate("doj"));
  }
}
